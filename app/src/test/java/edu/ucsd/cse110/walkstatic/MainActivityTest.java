...
import edu.ucsd.cse110.walkstatic.mocks.FirebaseMocks;
...
public class MainActivityTest {
    ...
    public void setUp() {
        ...
        FirebaseMocks.MockStorageWatcher mockStorageWatcher = new FirebaseMocks.MockStorageWatcher();
        DefaultStorage.setDefaultStorageWatcher(user -> mockStorageWatcher);

        FirebaseMocks.MockTeammateRequestStore mockTeammateRequestStore = new FirebaseMocks.MockTeammateRequestStore();
